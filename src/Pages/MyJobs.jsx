...
const MyJobs = () => {
  const email = "googlehr@gmail.com";
  ...
  return (
    <div className="maw-w-sreen-2xl container mx-auto xl:px-24 px-4">
      <div className="my-jobs-container"></div>
      ...
      <section className="py-1 bg-blueGray-50">
        <div className="w-full xl:w-8/12 mb-12 xl:mb-0 px-4 mx-auto mt-4">
          ...
          <div className="flex items-center justify-center text-black space-x-8" >
            {
              currentPage > 1 && (
